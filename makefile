...
JoystickGetAvailable.mexmaci: JoystickGetAvailable.o32 osx_joystick.o32
	$(CXX) -o $@ $^ $(LDFLAGS) $(LM32FLAGS) $(ARCH32)

JoystickGetAvailable.mexmaci64: JoystickGetAvailable.o64 osx_joystick.o64
...
test: osx_joystick.o64 test.o
	$(CXX) -o $@ $^ $(LDFLAGS)

test.o: test.cpp osx_joystick.hpp
	$(CXX) -c -o $@ $(CXXFLAGS) $<

osx_joystick.o64: osx_joystick.cpp osx_joystick.hpp
	$(CXX) -c -o $@ $(CXXFLAGS) $(ARCH64) $<

osx_joystick.o32: osx_joystick.cpp osx_joystick.hpp
